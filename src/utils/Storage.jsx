...
export const Store = (typeof window !== 'undefined' && window.localStorage) || LocalStorage();
...
export function Storage(prefix) {
    return {
        ...
        set:  (key, value) => Store.setItem( prefixKey(prefix, key), JSON.stringify(value) ),
    }
}
